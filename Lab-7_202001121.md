...
## **Following equivalence classes can be identified:** 

1. Valid dates: The input triple (day, month, year) that represent a valid date in the Gregorian calendar, such as (4, 5, 1998).
2. Invalid dates: The input triple (day, month, year) that represent an invalid date, such as (31, 2, 2002) or (29, 2, 1721).
...
**Valid dates:**
1) Calculate previous date for (16, 9, 2022) 15, 9, 2022
2) Calculate previous date for (1, 1, 2015) 31, 12, 2014
3) Calculate previous date for (30, 1, 2000) 29, 1, 2000

**Invalid dates:**<br>
1) Calculate previous date for (29, 2, 2002) Invalid date
2) Calculate previous date for (31, 4, 2000) Invalid date
3) Calculate previous date for (30, 2, 2020) Invalid date

**Out of range dates:**<br>
1) Calculate previous date for (0, 6, 2011) Invalid date
2) Calculate previous date for (14, 13, 2021) Invalid date
